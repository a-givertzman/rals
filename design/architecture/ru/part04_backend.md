...
* Отправляет текущие значения износа и сигнализации клиентам
    При переходе состояния:
        - в warning → генерируется событие класса Warning
        - в critical → событие Alarm + флаг Тревога
Severity — внутренняя классификация модели износа.
