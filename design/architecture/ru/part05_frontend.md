...
* **Page | Главный экран**
    ...
    * **Графики ТО** (список) (Центральная часть -> Вкладка Сервис)
        ...
        * Добавление работ (отобразить вложенным списком)
            * Добавление Работ из списка ***Шаблонов работ***
            * Кастомизация списка работ (***Редактор Работ***)
            * Планирование
                - На конкретную дату
                - С периодичностью и/или по наработке
                - По наработке и/или ресурсу
...
* Offline-режим (у мастера может не быть связи, а приложение должно нормально работать хотя бы с задачей)
* Огромные кнопки
* Минимум текста
* Работа в перчатках
* Не нужен список всех задач
* **Сканировать QR** станка 
    -> **Техкарта**
    -> **Список операций**
        -> Галочки "**Выполнено**"
            -> **Отчет** 
                -> Приложить **фото**
                -> Записать аудио (как вариант)
