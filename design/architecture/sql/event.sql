...
/*
    PROCESS EVENT - Журнал событий сигнализации
*/

--
-- Рекомендации по железу
-- 
-- | Количество строк | Размер таблицы (heap) | Размер индекса | Общий размер | Рекомендуемая RAM | Рекомендуемый CPU |
-- | ---------------- | --------------------- | -------------- | ------------ | ----------------- | ----------------- |
-- | 1 млн            | ~70 MB                | ~50 MB         | ~120 MB      | 2–4 GB            | 2 core            |
-- | 5 млн            | ~350 MB               | ~250 MB        | ~600 MB      | 4–8 GB            | 2–4 core          |
-- | 10 млн           | ~700 MB               | ~500 MB        | ~1.2 GB      | 8 GB              | 4 core            |
-- | 20 млн           | ~1.4 GB               | ~1 GB          | ~2.4 GB      | 16 GB             | 4–8 core          |
-- | 50 млн           | ~3.5 GB               | ~2.5 GB        | ~6 GB        | 32 GB             | 8 core            |
-- | 100 млн          | ~7 GB                 | ~5 GB          | ~12 GB       | 64 GB             | 8–16 core         |
-- | 200 млн          | ~14 GB                | ~10 GB         | ~24 GB       | 128 GB            | 16+ core          |
